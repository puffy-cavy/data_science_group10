...
curdate = policy_df.loc[policy_df['State'] == state_name]["Closed restaurants x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
my_dt = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
close_rest_2 = my_dt.isocalendar()[1]
if cur[0] > '2020':
    close_rest_2+=52


#reopen restaurants x2
curdate = policy_df.loc[policy_df['State'] == state_name]["Reopened restaurants x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
my_dt = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
reopen_rest_2 = my_dt.isocalendar()[1]
if cur[0] > '2020':
    reopen_rest_2+=52
...
curdate = policy_df.loc[policy_df['State'] == state_name]["Closed bars x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
bar_dt_2 = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
close_bar_2 = bar_dt_2.isocalendar()[1]
if cur[0] > '2020':
    close_bar_2+=52



curdate = policy_df.loc[policy_df['State'] == state_name]["Reopened bars x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
reopen_bar_2 = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
bar_reopen_2 = reopen_bar_2.isocalendar()[1]
if cur[0] > '2020':
    bar_reopen_2+=52



curdate = policy_df.loc[policy_df['State'] == state_name]["Closed movie theaters x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
movie_2 = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
movie_close_2 = movie_2.isocalendar()[1]
if cur[0] > '2020':
    movie_close_2 += 52

curdate = policy_df.loc[policy_df['State'] == state_name]["Reopened movie theaters x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
movieend_2 = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
movie_reopen_2 = movieend_2.isocalendar()[1]
if cur[0] > '2020':
    movie_reopen_2 += 52
...
curdate = policy_df.loc[policy_df['State'] == state_name]["Public face mask mandate start x2"].to_string(index=False).strip()
cur = curdate.split('/')
cur[0],cur[2] = cur[2],cur[0]
cur[1],cur[2] = cur[2],cur[1]
inputdate = '-'.join(cur)
mask_dt_2 = datetime.datetime.strptime(inputdate, '%Y-%m-%d')
mask_start_2 = mask_dt_2.isocalendar()[1]
if cur[0] > '2020':
    mask_start_2+=52
